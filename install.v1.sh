...
#   --config FILE       Use specified config file instead of dotfiles.yaml
#
# EXAMPLES:
...
# CONFIG_FILE can be overridden via --config flag
...
create_symlinks() {
    ...
    # Export options for the script
    export DRY_RUN FORCE VERBOSE BACKUP BACKUP_DIR CONFIG_FILE
